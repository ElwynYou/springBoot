 ...
 * 
 * @deprecated 已经迁移至iSecBigdata工程中，请使用RpcFindCompanionService远程接口替换 张云鹏 2017-01-18
 */
@Service
public class FindCompanionService {
	 ...
	 * @return
	 */
	public List<MachineInfo> getMachineInfoByServiceCode(Map map) {
	 ...
	 * @return
	 */
	public List<HScanCollectionApEntity> getScanCollectionAp(List serviceCode) {
	 ...
	 * impala查找同伴信息
	 */
	public DataTablesResponse getCompanionInfo(DataTablesRequest dataTablesRequest) {
		...
		// 获取用户能查询的serviceCode
		List<String> serviceCode = getServiceCodeByArea(getMachineInfoDao);
	 ...
	 * @return
	 */
	public List getInitEq(List<HScanEndingTraceEntity> data) {
		if (data != null) {
	 ...
	 * @return
	 */
	public static List<HScanEndingTraceEntity> mergeInfo(List<MachineInfo> machineInfo, List<HScanEndingTraceEntity> traceEntityList) {
	 ...
	 * @return
	 */
	public DataTablesResponse getCompanionGroup(DataTablesRequest dataTablesRequest) {
		dataTablesRequest.setModeClass(HScanEndingTraceEntity.class);
		DataTablesResponse dtres = new DataTablesResponse(dataTablesRequest);
		long count = 0;
