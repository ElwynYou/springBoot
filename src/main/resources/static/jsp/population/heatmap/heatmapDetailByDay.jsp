...
<head>
    <style type="text/css">
        ...
        .tablepad{margin-top: 20px;padding: 0 80px;}
    </style>
...
<div class="row page-component-element">
	<div id="tracelocation_control">
        <form id="searchForm" class="form-inline" action="${ctx }/population/heatmap/heatmapDetailByDay" target="<%=request.getHeader("X-Requested-With") != null?"ajax":"_self" %>">
