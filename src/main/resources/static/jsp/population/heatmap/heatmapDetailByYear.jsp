...
<div class="row page-component-element">
	<div id="tracelocation_control">
        <form id="searchForm" class="form-inline" action="${ctx }/population/heatmap/heatmapDetailByYear" target="<%=request.getHeader("X-Requested-With") != null?"ajax":"_self" %>">
                ...
                <div class="form-group">
                    <div class="input-group input-medium  input-daterange"
                        ...
                        <input name="queryTime" value="${heatMapDetail.queryTime }"
                        	onfocus="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-%M',readOnly:true,opposite:true,disabledDates:['${heatMapDetail.limitingTime}-..']})"
