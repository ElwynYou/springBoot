...
public class IdentityContrasService {
	 ...
	 */
	public List<String> getServiceCode(User user) {
		// 获取当前用户和城区
	...
	public void addServiceCodeTodataTablesRequest(User user,DataTablesRequest<?> dataTablesRequest) {
		Map<String, Object> map = dataTablesRequest.getFormData();
		map.put("serviceCode", this.getServiceCode(user));
