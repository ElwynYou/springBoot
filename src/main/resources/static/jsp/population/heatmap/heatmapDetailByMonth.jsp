...
<div class="row page-component-element">
	<div id="tracelocation_control">
        <form id="searchForm" class="form-inline" action="${ctx }/population/heatmap/heatmapDetailByMonth" target="<%=request.getHeader("X-Requested-With") != null?"ajax":"_self" %>">
            ...
            <div class="col-xs-12" style="padding: 15px 0;">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="imsiCode" type="text" class="form-control" value="${heatMapDetail.imsiCode }">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group input-medium  input-daterange"
                        ...
                        <input name="queryTime" value="${heatMapDetail.queryTime }" 
                         onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',readOnly:true,opposite:true,disabledDates:['${heatMapDetail.limitingTime}-..']})"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <sys:city value="${heatMapDetail.city }" name="city"/>
                    </div>
                </div>
               
                <div class="form-group">
                    <div class="input-group">
                        <input id="highRisk" name="highRisk"  value="1" ${heatMapDetail.highRisk == 1 ? "checked":"" } type="checkbox"/>
                        <label for="highRisk">关注人群</label>
                        <input id="prevent" name="prevent" value="1"  ${heatMapDetail.prevent == 1 ? "checked":"" } type="checkbox"/>
            ...
            <input hidden="hidden" id="limitingTime" name="limitingTime"  value=" ${heatMapDetail.limitingTime}">
            <input hidden="hidden" id="configId" name="configId"  value="${heatMapDetail.configId}">
        </form>
