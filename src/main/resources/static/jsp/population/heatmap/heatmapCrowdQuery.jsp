...
<body>
	<div class="row">
        <form id="searchForm" class="form-inline" action="${ctx }/population/heatmap/heatmapCrowdQuery" method="post" target="<%=request.getHeader("X-Requested-With") != null?"ajax":"_self" %>">
