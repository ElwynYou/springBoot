...
<div class="row page-component-element">
	<div id="tracelocation_control">
        <form id="searchForm" class="form-inline" action="${ctx }/population/crowd/emphasisAreaSuspicious" target="<%=request.getHeader("X-Requested-With") != null?"ajax":"_self" %>">
            ...
            <div class="col-xs-12" style="padding: 15px 0;">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="imsiCode" type="text" class="form-control" value="${emphasisAreaSuspicious.imsiCode }">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon">捕获时间</span> 
                        <input name="beginTime" value="${emphasisAreaSuspicious.beginTime}" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:'%y-%M-%d %H:%m'})"
                                                                            class="form-control datetime-picker"
                                                                            id="startTime" type="text"> <span class="input-group-addon">-</span>
                        <input name="endTime" value="${emphasisAreaSuspicious.endTime}" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:'%y-%M-%d %H:%m'})"
                      class="form-control datetime-picker"
            ...
            <input hidden="hidden" id="configId" name="configId"  value="${emphasisAreaSuspicious.configId}">
        </form>
...
$(function(){
  ...
  function updateSuspicious(imsiCode,status){
	  showLoading();
	  var url = "${ctx}/population/crowd/updateSuspicious?imsiCode="+imsiCode+"&status=" + status +"&configId="+$("#configId").val();
